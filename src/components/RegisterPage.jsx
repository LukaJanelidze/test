...
export default function SignUpSignIn() {
    ...
    const [arePasswordsEmpty, setArePasswordsEmpty] = useState(false);
    ...
    const handlePassword1Change = (e) => {
        ...
        if (newPassword.trim() === '' || password2.trim() === '') {
    ...
    const handlePassword2Change = (e) => {
        ...
        if (newPassword.trim() === '' || password1.trim() === '') {
            setArePasswordsEmpty(true);
            setPasswordsMatch(true);
        } else {
            setArePasswordsEmpty(false);
            ...
            <div className='register-main'>
                    <div className='register-box'>
                        ...
                        <form onSubmit={handleRegistrationSubmit}>
                            ...
                            {(!isEmailValid && formSubmitted) && <span className="emailerror">არ არის სწორი Email!</span>}
                            ...
                            {(arePasswordsEmpty && formSubmitted) && (
                                <span className='passworderror'>გთხოვთ შეიყვანოთ პაროლი!</span>
                            )}

                            {(!passwordsMatch && formSubmitted) && (
                                <span className='passworderror'>პაროლები ერთმანეთს არ ემთხვევა!</span>
                            )}
